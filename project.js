...
// Cited source from https://gist.github.com/zamboney/ed398efded1a88f5217682eef750776c//
$(function() {
    var body = $('#starshine'),//The element from the HTML being identified as an object by the $.
        template = $('.template.shine'), //The element from the HTML being identified as an object by the $.
        stars =  500,
        sparkle = 20;
    ...
    var createStar = function() {
      template.clone().removeAttr('id').css({// Removing the attribute property style of an element to give to a more specific
        top: (Math.random() * 100) + '%',//Makes the sparkles spread throughtout the page
        left: (Math.random() * 100) + '%',
        webkitAnimationDelay: (Math.random() * sparkle) + 's',//Allows the sparkles to fade in and out at different times instead of all at once
        mozAnimationDelay: (Math.random() * sparkle) + 's'//Allows the sparkles to fade in and out all together
